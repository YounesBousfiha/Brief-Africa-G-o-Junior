        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
            ...
            <div class="collapse navbar-collapse" id="navcol-3">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../public/pages/allCountries.php" style="color: rgb(0,0,0);">all Countries</a></li>
    ...
    <div class="container py-4 py-xl-5">
        <div class="row mb-4 mb-lg-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                <h2>Our Team</h2>
                <p class="w-lg-50">Our team is dedicated to creating an engaging and educational platform that helps students explore the richness of Africa’s countries and cities</p>
            </div>
        </div>
            ...
            <div class="row row-cols-2 row-cols-md-4">
                ...
                <div class="col">
                    <div class="p-3">
                        ...
                        <p class="mb-0">registred Students</p>
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <h4 class="display-5 fw-bold text-white mb-0">89</h4>
                        <p class="mb-0">Quiz Taken</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="text-center">
        <div class="container text-muted py-4 py-lg-5">
            <ul class="list-inline">
                <li class="list-inline-item me-4"><a class="link-secondary" href="#">Historique</a></li>
                <li class="list-inline-item me-4"><a class="link-secondary" href="#">Contact US</a></li>
                <li class="list-inline-item"><a class="link-secondary" href="#">Visit US</a></li>
            </ul>
            <ul class="list-inline">
